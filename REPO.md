# 📚 Veterinary Biochemistry Studio — GitHub Repository Guide

Welcome to the **Veterinary Biochemistry Studio** GitHub repository. This folder contains all the core source code, content files, stylesheets, scripts, tools, and configuration needed to run and deploy the web application.
...
│   ├── data-syllabus.JS        ← Master index: 3 units, 55 theory + 22 practical topics
│   ├── data-theory-unit1.JS    ← General Veterinary Biochemistry (17 topics)
│   ├── data-theory-unit2.JS    ← Intermediary Metabolism (22 topics)
│   ├── data-theory-unit3.JS    ← Veterinary Analytical Biochemistry (16 topics)
│   ├── data-practical.JS       ← Practical Biochemistry syllabus (22 topics)
...
│   ├── theory/                 ← Biochemical pathways, structures, and cycle diagrams
│   ├── practical/              ← Test tubes, colorimetric curves, and lab procedures
...
│   ├── start-server.bat        ← Double-click to launch local server at http://localhost:5199
...
├── service-worker.js           ← Offline cache-first service worker (vbioc-v1)
...
3. Pushes to your GitHub repository: `https://github.com/fazalzama77-sys/VET-BIOCHEMISTRY.git`

Repository Web URL: [https://github.com/fazalzama77-sys/VET-BIOCHEMISTRY](https://github.com/fazalzama77-sys/VET-BIOCHEMISTRY)
