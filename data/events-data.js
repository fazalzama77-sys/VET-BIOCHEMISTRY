/* ================================================================
 * VETERINARY BIOCHEMISTRY — DEPARTMENT EVENTS DATA
 * ================================================================
...
window.IVRI_BIOCHEMISTRY_EVENTS_CONFIG = {
    // STAFF TOGGLE: true = show the section; false = hide it completely.
    sectionEnabled: true,
    sectionTitle: 'Biochemistry Announcements & Seminars',
    sectionSubtitle: 'Upcoming academic programmes, clinical diagnostic workshops, lab seminars, and official updates.',
    ...
    // Add event blocks here when a programme is announced.
    events: []
};
