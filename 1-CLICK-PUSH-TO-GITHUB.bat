...
echo.
echo ============================================================
echo   VETERINARY BIOCHEMISTRY STUDIO - 1-CLICK GITHUB UPLOADER
echo ============================================================
echo.
...
set "SRC=%ROOT%"
set "DEST=%ROOT%\repo"
set "REPO_URL=https://github.com/fazalzama77-sys/VET-BIOCHEMISTRY.git"
...
if %ERRORLEVEL% EQU 0 (
    ...
    git commit -m "Update Biochemistry Studio content (%date% %time%)"
)
