...
var app = (function () {
  ...
  function getUnitIcon(u) {
    if (!u) return "book";
    if (u.icon && ICONS[u.icon]) return u.icon;
    var no = parseInt(u.no, 10);
    if (u.stream === "practical") {
      switch (no) {
        case 1: return "lab";
        case 2: return "pulse";
        case 3: return "microscope";
        default: return "lab";
      }
    }
    switch (no) {
  ...
  function _initLandingCanvas() {
    ...
    function renderLoop() {
      ...
      if (width > 600) {
        ...
        ctx.fillText("VET_BIOCHEMISTRY_STUDIO // UNITS_1_3_ONLINE", width - 240, txtY + 13);
      }
  ...
  var SPOTTERS_OF_THE_DAY = [
    {
      name: "Bovine Ketosis (Acetonemia / Ketonemia)",
      organ: "Liver & Peripheral Circulation (Bovine)",
      etiology: "Severe negative energy balance in early lactation triggering excessive adipose lipolysis and oxaloacetate depletion.",
      gross: "Rapid loss of body condition, abrupt drop in milk yield, inappetence (refusing concentrates), hard dry feces, and characteristic sweet/fruity breath odor (acetone).",
      micro: "Severe hepatic lipidosis (steatosis); hepatocytes distended with multiple lipid vacuoles displacing nuclei to the periphery (Oil Red O / Sudan black positive).",
      viva: "Primary circulating ketone body in ruminants is beta-hydroxybutyrate (BHBA > 1.4 mmol/L subclinical, > 3.0 mmol/L clinical). Rothera's nitroprusside test detects acetoacetate and acetone (purple permanganate ring). Treatment: IV 50% dextrose + oral propylene glycol.",
      unitId: "unit-3",
      topicId: "u3-t02",
      badge: "Metabolic Disorder"
    },
    {
      name: "Canine Diabetic Ketoacidosis (DKA)",
      organ: "Endocrine Pancreas & Kidneys (Canine)",
      etiology: "Absolute insulin deficiency (Type 1 like immune-mediated beta-cell loss) accompanied by glucagon/cortisol counter-regulatory surge.",
      gross: "Severe polyuria, polydipsia, polyphagia with progressive weight loss, bilateral cataracts, dehydration, acetone breath, and rapid deep respiration (Kussmaul breathing).",
      micro: "Islets of Langerhans demonstrate profound beta-cell vacuolation, degeneration, and insulitis. Renal proximal tubules show glycogen nephrosis (Armanni-Ebstein lesion).",
      viva: "Blood glucose exceeds canine renal threshold (~180 mg/dL), causing osmotic diuresis and electrolyte wasting. Serum fructosamine (>350-400 micromol/L) confirms sustained hyperglycemia over past 2-3 weeks. High anion gap metabolic acidosis ensues.",
      unitId: "unit-3",
      topicId: "u3-t01",
      badge: "Endocrine Biochemistry"
    },
    {
      name: "Pregnancy Toxaemia (Twin Lamb Disease)",
      organ: "Liver & Brain (Ovine)",
      etiology: "Inability of late-gestation ewe bearing multiple fetuses to meet enormous fetal glucose demands under restricted ruminal capacity.",
      gross: "Affected ewes separate from flock, exhibit apparent blindness, tremors, star-gazing, teeth grinding, recumbency, and coma. Liver is markedly enlarged, pale yellow, friable, and greasy.",
      micro: "Diffuse panlobular microvesicular and macrovesicular hepatic lipidosis. Hypoglycemic encephalopathy with ischemic neuronal degeneration in cerebral cortex.",
      viva: "Blood glucose plunges below 20-30 mg/dL while BHBA rises > 2.5 mmol/L. Fetus consumes up to 70% of maternal glucose. Treatment is urgent IV dextrose and induction of parturition or emergency caesarean section if near term.",
      unitId: "unit-3",
      topicId: "u3-t02",
      badge: "Ovine Metabolic Crisis"
    },
    {
      name: "Neonatal Hypoglycaemia in Baby Pigs",
      organ: "Liver & Central Nervous System (Porcine)",
      etiology: "Failure of suckling / chilling in newborn piglets with negligible hepatic glycogen reserves and immature gluconeogenic enzymes.",
      gross: "Piglets huddle together, shiver violently, vocalize with weak squeals, develop ataxia, paddling convulsions, hypothermia (<37°C), and coma within 24-48 hours.",
      micro: "Complete glycogen depletion in hepatocytes (PAS-negative). Severe cerebral edema and ischemic laminar necrosis of cortical neurons.",
      viva: "Newborn piglets have only 15-20 hours of glycogen reserves and virtually zero body fat; PEPCK is low at birth. Blood glucose drops < 40-50 mg/dL. Emergency treatment requires warming (32-35°C) and intraperitoneal 5-10% warm sterile glucose.",
      unitId: "unit-3",
      topicId: "u3-t03",
      badge: "Neonatal Biochemistry"
    },
    {
      name: "Obstructive (Post-Hepatic) Jaundice",
      organ: "Biliary System & Liver (Canine / Feline)",
      etiology: "Obstruction of extrahepatic bile duct (cholelithiasis, pancreatitis, or biliary neoplasia) preventing bile excretion into duodenum.",
      gross: "Intense yellowish-orange discoloration (icterus) of sclera, oral mucous membranes, and non-pigmented skin; dark golden-orange urine and pale clay-colored (acholic) feces.",
      micro: "Canalicular bile plugs, periportal bile duct proliferation, and bile pigment accumulation within hepatocytes and Kupffer cells (Hall's bile stain positive).",
      viva: "Serum bilirubin > 2.0 mg/dL with >50% conjugated (direct) bilirubin. Van den Bergh reaction shows immediate 'direct positive'. Urine contains conjugated bilirubin (water-soluble) with zero urobilinogen. Striking surge in serum ALP and GGT.",
      unitId: "unit-3",
      topicId: "u3-t08",
      badge: "Diagnostic Enzymology"
    },
    {
      name: "Congenital Portosystemic Shunt (PSS) & Hyperammonemia",
      organ: "Portal Vein & Brain (Canine)",
      etiology: "Vascular anomaly allowing portal blood to bypass hepatic sinusoids directly into systemic circulation without metabolic detoxification.",
      gross: "Small, microhepatic liver; urinary bladder containing radiolucent golden-brown ammonium biurate uroliths ('thorn-apple' crystal morphology).",
      micro: "Hepatic lobules small with hypoplastic portal veins, arteriolar proliferation, and absence of normal portal venules. Brain displays Alzheimer type II astrocytosis in cerebral cortex.",
      viva: "Failure of urea cycle extraction leads to postprandial hyperammonemia (>100 micromol/L), inducing hepatic encephalopathy. Markedly elevated pre- and post-prandial serum bile acids with characteristically low BUN (liver starved of ammonia substrate).",
      unitId: "unit-3",
      topicId: "u3-t10",
      badge: "Organ Function Test"
    }
  ];
  ...
  function renderHome() {
    ...
    var pracTopics = 0, pracRead = 0;
    syllabus.practical.forEach(function (u) {
      pracTopics += u.topics.length;
      pracRead += u.topics.filter(function (t) { return readMap[t.id]; }).length;
    });
    var pracPct = pracTopics ? Math.round((pracRead / pracTopics) * 100) : 0;
    ...
    var rankTitle = "Biochemistry Apprentice";
    if (masteryXp >= 800) rankTitle = "Master Veterinary Biochemist";
    ...
    var termKeys = Object.keys((window.glossary && glossary.terms) || {});
    var dailyTermKey = termKeys.length ? termKeys[dayOfYear % termKeys.length] : "glycolysis";
    var dailyTermDef = (window.glossary && glossary.terms[dailyTermKey]) || "Cytosolic catabolic pathway converting glucose to pyruvate with net ATP generation.";

    // Prioritize resume card message
    var resumeIcon = "theory";
    var resumeTitle = "Ready to start studying?";
    var resumeSubtitle = "Begin with Unit 1: General Veterinary Biochemistry.";
    ...
    if (q.incorrect && q.incorrect.length > 0) {
      ...
      resumeSubtitle = "Reinforce weak spots and master tricky biochemistry questions.";
    ...
    view.innerHTML =
      ...
      '<div class="home-scholar-bar">' +
        '<div class="home-scholar-greeting">' +
          ...
          '<p class="home-greeting-sub">Veterinary Biochemistry Companion · B.V.Sc &amp; A.H. Year 2</p>' +
        '</div>' +
      ...
      '<section class="hero">' +
        ...
        '<div class="hero__inner">' +
          ...
          '<h1 class="hero__title">Veterinary Biochemistry<br><span class="hero__title-accent">Studio</span></h1>' +
      ...
      '<div class="home-actions-grid">' +
        '<a class="home-action-tile" href="#/quiz/grand">' +
          ...
          '<p class="action-tile-desc">Instant randomized 10-question biochemistry sprint with real-time scoring.</p>' +
      ...
      /* 4. Biochemistry Spotter of the Day (Clinical Case Spotlight) */
      '<div class="home-spotter-card">' +
        '<div class="spotter-header">' +
          '<div>' +
            '<span class="spotter-eyebrow">' + icon("sparkle") + ' BIOCHEMISTRY SPOTTER OF THE DAY · ' + esc(spotter.badge) + '</span>' +
        ...
        '<div class="spotter-gross-box">' +
          '<h4>' + icon("eye") + ' Cardinal Clinical &amp; Pathological Hallmark</h4>' +
        ...
        '<div id="spotter-details-drawer" class="spotter-details-drawer">' +
          '<div class="spotter-details-grid">' +
            ...
            '</div>' +
            '<div class="spotter-detail-item">' +
              '<h5>' + icon("microscope") + ' Histopathological &amp; Cellular Hallmark</h5>' +
      ...
      '<h2 class="mt-10">Explore Biochemistry Domains</h2>' +
      '<p class="muted mt-1">Structured comprehensive curriculum following VCI MSVE 2016 guidelines.</p>' +
      '<div class="home-domains-grid">' +
        homeDomainCard("theory", "Theory Curriculum", "Three units · 55 topics", "General veterinary biochemistry, intermediary metabolism, and veterinary analytical biochemistry.", readPct, readCount + " / " + allTopics + " read", "#/theory", "ico--blue") +
        homeDomainCard("practical", "Practical Diagnostics", "Three units · 22 practical labs", "Qualitative tests, colorimetry, blood estimations, urinalysis, and clinical enzymology.", null, "3 Practical Units", "#/practical", "ico--teal") +
        ...
        homeDomainCard("why", "WHY Mechanisms", totalWhy + " comparative explanations", "Comparative species biochemistry, metabolic pathways, and clinical biochemical mechanisms.", null, totalWhy + " Mechanisms", "#/why", "ico--purple") +
        homeDomainCard("dashboard", "Clinical Dashboard", "Analytics &amp; SRS pipeline", "Biochemistry mastery gauge, 84-day heatmap, weak spots and Leitner memory queue.", Math.round(masteryXp / 10), masteryXp + " / 1000 XP", "#/dashboard", "ico--blue") +
      '</div>' +

      /* 6. VCI Board Annual Examination Structure */
      '<h2 class="mt-12">VCI Annual Board Examination Structure</h2>' +
      '<p class="muted mt-2">The Veterinary Council of India annual examination encompasses three comprehensive theory units (100 Marks) and three practical units (60 Marks).</p>' +
      '<div class="home-exam-grid">' +
        homePaperCard("Annual Examination", "General, Metabolism &amp; Analytical Biochemistry", [1, 2, 3], p1Read, p1Topics, p1Pct, "paper/annual", "paper-badge--p1", "fill--blue") +
        homePaperCard("Practical Board Exam", "Laboratory Diagnostic Procedures &amp; Estimations", [1, 2, 3], pracRead, pracTopics, pracPct, "practical", "paper-badge--p2", "fill--teal") +
      '</div>' +
      ...
      '<div class="footer-credits-wrap">' +
        ...
        '<div class="footer-nav">' +
          '<div class="footer-nav__head">Browse Veterinary Biochemistry</div>' +
          '<div class="footer-nav__links">' +
            '<a href="#/theory">Theory Units 1–3</a>' +
            '<a href="#/practical">Practical Units 1–3</a>' +
  ...
  function renderStream(stream) {
    ...
    var cards = units.map(function (u) {
      ...
      return '<a class="card card--link unitcard" href="#/unit/' + u.id + '">' +
        '<div class="row row--wrap">' +
          ...
          '<span class="chip push">' + "Annual Exam" + '</span>' +
        '</div>' +
    ...
    view.innerHTML =
      '<div class="pagehead">' +
        '<span class="eyebrow">' + (isTheory ? "2 credit hours" : "1 credit hour") + '</span>' +
        '<h1>' + (isTheory ? icon("theory") + ' Theory' : icon("practical") + ' Practical') + '</h1>' +
        '<p class="lede">' + (isTheory
          ? "The three theory units of the VCI Veterinary Biochemistry syllabus (Units 1–3, Annual Examination)."
          : "The three practical units: solutions and buffers, enzyme kinetics and estimations, and clinical diagnostic biochemistry.") + '</p>' +
    ...
    if (hasContent(t.id)) {
      ...
      body =
        ...
        (c.img
          ...
          : '<div class="biochemistry-image-placeholder"><div class="biochemistry-placeholder-body">' +
              icon("search") +
              '<div class="biochemistry-placeholder-title">High-Quality Biochemistry Visuals in Development</div>' +
              '<div class="biochemistry-placeholder-sub">Carefully curated colony morphology, Gram stains, biochemical media, and diagnostic micrographs are in compilation.</div>' +
            '</div></div>') +
  ...
  var onboardSlides = [
    {
      ...
      title: "Veterinary Biochemistry Studio",
    ...
    },
    {
      ...
      body: "Install this app on your phone, tablet, or laptop. It works completely offline in biochemistry diagnostic labs, livestock farms, classrooms, and hostels with zero internet required.",
      icon: "download"
    }
  ];
      ...
      var filterTabsHtml =
        '<div class="qa-paper-nav">' +
          '<button class="qa-paper-tab is-active" data-paper="all">' +
            icon("filter") + ' All Units <span class="count-badge">3 Units · ' + totalQ + ' Q</span>' +
          '</button>' +
          '<button class="qa-paper-tab" data-paper="unit-1">' +
            icon("atom") + ' Unit 1 (General) <span class="count-badge">' + qaCount("unit-1") + ' Q</span>' +
          '</button>' +
          '<button class="qa-paper-tab" data-paper="unit-2">' +
            icon("cycle") + ' Unit 2 (Metabolism) <span class="count-badge">' + qaCount("unit-2") + ' Q</span>' +
          '</button>' +
          '<button class="qa-paper-tab" data-paper="unit-3">' +
            icon("flask") + ' Unit 3 (Analytical) <span class="count-badge">' + qaCount("unit-3") + ' Q</span>' +
          '</button>' +
        '</div>';

      var cardsHtml = unitData.map(function (d) {
        var u = d.unit;
        var paperLabel = "Annual Exam";
  ...
  function exportHighlights() {
    ...
    var lines = [
      "# Veterinary Biochemistry Study Highlights",
  ...
  function exportNotes() {
    ...
    var lines = [
      "# Veterinary Biochemistry Personal Notes",
      "ICAR-Indian Veterinary Research Institute · Izatnagar",
      "Exported on: " + new Date().toLocaleDateString() + "\n"
    ];
    keys.forEach(function (id) {
      ...
      var toolbarHtml =
        '<div class="lib-topbar">' +
          '<div class="hl-toolbar">' +
            '<div class="hl-search-wrap">' +
              icon("search", "hl-search-icon") +
              '<input type="search" class="hl-search-input" id="gloss-search" placeholder="Search ' + allTerms.length + ' biochemistry definitions and terms…" value="' + esc(state._glossSearch || "") + '">' +
            '</div>' +
            '<div class="hl-filter-chips">' +
  ...
  function renderMe() {
    ...
    view.innerHTML =
      ...
      '<div class="card mb-4">' +
        ...
        '<p class="muted mt-2">Get an alert when flashcards and high-yield biochemistry questions are due for active recall.</p>' +
  ...
  function _maybeShowSrsNotification() {
    ...
    var lastNotified = localStorage.getItem("vbioc-notify-last");
    if (lastNotified === todayStr) return;

    var due = store.dueSrs().length;
    var msg = due > 0
      ? "You have " + due + " question" + (due === 1 ? "" : "s") + " due for review today in Spaced Repetition."
      : "Time for your daily Veterinary Biochemistry recall review!";
    ...
    if (navigator.serviceWorker && navigator.serviceWorker.ready) {
      navigator.serviceWorker.ready.then(function (reg) {
        if (reg.showNotification) reg.showNotification("Veterinary Biochemistry Studio", opts);
        else new Notification("Veterinary Biochemistry Studio", opts);
      }).catch(function () {
        try { new Notification("Veterinary Biochemistry Studio", opts); } catch (e) {}
      });
    } else {
      try { new Notification("Veterinary Biochemistry Studio", opts); } catch (e) {}
    }
    localStorage.setItem("vbioc-notify-last", todayStr);
  }
  ...
  function setSrsNotificationTime(val) {
    ...
    localStorage.removeItem("vbioc-notify-last");
    _maybeShowSrsNotification();
    _scheduleNextSrsNotification();
  ...
  function openSearch() {
    if (window.searchEngine && searchEngine.open) {
      searchEngine.open();
      return;
    }
