/* ============================================================
   ...
   ------------------------------------------------------------
   All keys are prefixed "vbioc-" so this site can never collide
...
var store = (function () {
  ...
  function exportBackup() {
    var payload = { _app: "vet-biochemistry-studio", _version: 1, _at: new Date().toISOString(), data: {} };
    ...
    a.download = "vet-biochemistry-backup-" + today() + ".json";
  ...
  function importBackup(file, onDone) {
    ...
    r.onload = function () {
      try {
        ...
        if (!p || p._app !== "vet-biochemistry-studio" || !p.data) {
